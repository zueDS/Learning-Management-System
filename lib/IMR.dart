...
class IMRPage extends StatelessWidget {
  const IMRPage({Key? key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('IMR'),
        backgroundColor: Color.fromRGBO(253, 255, 177, 100),
      ),
      body: Column(
        ...
        children: [
          ...
          Text(
            'Informational Management Retriaval 2023',
            style: TextStyle(
              fontSize: 18.0,
