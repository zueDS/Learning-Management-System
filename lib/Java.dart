...
class ProgrammignJava extends StatelessWidget {
  const ProgrammignJava({Key? key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Programming Java'),
        backgroundColor: Color.fromRGBO(177, 250, 255, 75),
      ),
      body: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              primary: Color.fromRGBO(177, 250, 255, 75),
            ),
            child: Text(
              'dashboard/modules/java',
